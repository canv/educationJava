...
//   * Как работает процедура репрезентации чисел?
        ...
        /*
          ...
          Данная операция невозможна т.к. Integer.MAX_VALUE имеет
          модификатор final что практическу приравнивает ее к константам
          и присвоить значение этой переменной можно лишь единожды
